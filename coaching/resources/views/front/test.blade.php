...
<!-- End Google Tag Manager (noscript) -->
    ...
    <nav class="navbar navbar-color-on-scroll navbar-transparent    fixed-top  navbar-expand-lg " color-on-scroll="100" id="sectionsNav">
        <div class="container">
            <div class="navbar-translate">
                <a class="navbar-brand" href="index-2.html">Material Kit PRO </a>
                        ...
                        <div class="top-right links">
                            @if (Auth::check())
                                <li class="button-container nav-item iframe-extern">
                                    <a href="https://www.creative-tim.com/buy/material-kit-pro?ref=presentation" target="_blank" class="btn  btn-rose   btn-round btn-block">
                                        <i class="material-icons">shopping_cart</i> Logout
                                    </a>
                                </li>
                            @else
                                <li class="button-container nav-item iframe-extern">
                                    <a href="https://www.creative-tim.com/buy/material-kit-pro?ref=presentation" target="_blank" class="btn  btn-rose   btn-round btn-block">
                                        <i class="material-icons">shopping_cart</i> Login
                                    </a>
                                </li>
                                <li class="button-container nav-item iframe-extern">
                                    <a href="https://www.creative-tim.com/buy/material-kit-pro?ref=presentation" target="_blank" class="btn  btn-rose   btn-round btn-block">
                                        <i class="material-icons">shopping_cart</i> Register
                                    </a>
                                </li>
                            @endif
                        </div>
    ...
    <div class="page-header header-filter clear-filter" data-parallax="true" style="background-image: url('jpg/bg0.jpg');">
        <div class="container">
            <div class="row">
    ...
    <div class="main main-raised">
        ...
        <div class="section section-navbars cd-section" id="navigation">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <nav class="navbar navbar-expand-lg bg-primary">
                            <div class="container">
                                <div class="navbar-translate">
                                    <a class="navbar-brand" href="https://demos.creative-tim.com/presentation.html">Menu</a>
                                    <button class="navbar-toggler" type="button" data-toggle="collapse" aria-expanded="false" aria-label="Toggle navigation">
                                        <span class="navbar-toggler-icon"></span>
                                        <span class="navbar-toggler-icon"></span>
                                        <span class="navbar-toggler-icon"></span>
                    ...
                    <div class="col-md-6">
                        ...
                        <nav class="navbar navbar-expand-lg bg-info">
                            <div class="container">
                                <div class="navbar-translate">
                                    <a class="navbar-brand" href="https://demos.creative-tim.com/presentation.html">Icons</a>
                                    <button class="navbar-toggler" type="button" data-toggle="collapse" aria-expanded="false" aria-label="Toggle navigation">
                                        <span class="navbar-toggler-icon"></span>
                                        <span class="navbar-toggler-icon"></span>
                                        <span class="navbar-toggler-icon"></span>
            ...
            <!--             navbar -->
            <div id="navbar">
                <div class="navigation-example" style="background-image: url('jpg/bg.jpg');">
                    <!--        rose navbar with search form -->
                    <nav class="navbar navbar-expand-lg bg-rose">
                        <div class="container">
                            <div class="navbar-translate">
                                <a class="navbar-brand" href="https://demos.creative-tim.com/presentation.html">Brand</a>
                                <button class="navbar-toggler" type="button" data-toggle="collapse" aria-expanded="false" aria-label="Toggle navigation">
                                    <span class="navbar-toggler-icon"></span>
                                    <span class="navbar-toggler-icon"></span>
                                    <span class="navbar-toggler-icon"></span>
                    ...
                    <nav class="navbar navbar-expand-lg bg-info">
                        <div class="container">
                            <div class="navbar-translate">
                                <a class="navbar-brand" href="https://demos.creative-tim.com/presentation.html">Info Color</a>
                                <button class="navbar-toggler" type="button" data-toggle="collapse" aria-expanded="false" aria-label="Toggle navigation">
                                    <span class="navbar-toggler-icon"></span>
                                    <span class="navbar-toggler-icon"></span>
                                    <span class="navbar-toggler-icon"></span>
                    ...
                    <nav class="navbar navbar-expand-lg bg-primary">
                        <div class="container">
                            <div class="navbar-translate">
                                <a class="navbar-brand" href="https://demos.creative-tim.com/presentation.html">Primary Color</a>
                                <button class="navbar-toggler" type="button" data-toggle="collapse" aria-expanded="false" aria-label="Toggle navigation">
                                    <span class="navbar-toggler-icon"></span>
                                    <span class="navbar-toggler-icon"></span>
                                    <span class="navbar-toggler-icon"></span>
                    ...
                    <nav class="navbar navbar-inverse navbar-expand-lg bg-dark" role="navigation-demo">
                        <div class="container">
                            ...
                            <div class="navbar-translate">
                                <a class="navbar-brand" href="https://demos.creative-tim.com/presentation.html">Navbar with notification</a>
                                <button class="navbar-toggler" type="button" data-toggle="collapse" aria-expanded="false" aria-label="Toggle navigation">
                                    <span class="navbar-toggler-icon"></span>
                                    <span class="navbar-toggler-icon"></span>
                                    <span class="navbar-toggler-icon"></span>
                                    ...
                                    <li class="dropdown nav-item">
                                        <a href="#pablo" class="profile-photo dropdown-toggle nav-link" data-toggle="dropdown">
                                            <div class="profile-photo-small">
                                                <img src="{{ url('jpg/avatar.jpg') }}" alt="Circle Image" class="rounded-circle img-fluid">
                                            </div>
                                        </a>
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <h6 class="dropdown-header">Dropdown header</h6>
                    ...
                    <nav class="navbar navbar-default navbar-expand-lg" role="navigation-demo">
                        <div class="container">
                            <!-- Brand and toggle get grouped for better mobile display -->
                            <div class="navbar-translate">
                                <a class="navbar-brand" href="https://demos.creative-tim.com/presentation.html">Navbar with profile</a>
                                <button class="navbar-toggler" type="button" data-toggle="collapse" aria-expanded="false" aria-label="Toggle navigation">
                                    <span class="navbar-toggler-icon"></span>
                                    <span class="navbar-toggler-icon"></span>
                                    <span class="navbar-toggler-icon"></span>
        ...
        <div class="section section-gray cd-section" id="footers">
            ...
            <div id="pre-footer-areas">
                ...
                <div class="subscribe-line subscribe-line-image" style="background-image: url(jpg/bg8.jpg);">
                    <div class="container">
                        <div class="row">
            ...
            <div class="section">
                ...
                <div id="footer-areas">
                    ...
                    <footer class="footer footer-white">
                        <div class="container">
                            <a class="footer-brand" href="https://www.creative-tim.com/">Material Kit PRO</a>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="gallery-feed">
                                            <img src="{{ url('jpg/card-profile6-square.jpg') }}" class="img img-raised rounded" alt="">
                                            <img src="{{ url('jpg/christian.jpg') }}" class="img img-raised rounded" alt="">
                                            <img src="{{ url('jpg/card-profile4-square.jpg') }}" class="img img-raised rounded" alt="">
                                            <img src="{{ url('jpg/card-profile1-square.jpg') }}" class="img img-raised rounded" alt="">
                                            <img src="{{ url('jpg/marc.jpg') }}" class="img img-raised rounded" alt="">
                                            <img src="{{ url('jpg/kendall.jpg') }}" class="img img-raised rounded" alt="">
                                            <img src="{{ url('jpg/card-profile5-square.jpg') }}" class="img img-raised rounded" alt="">
                                            <img src="{{ url('jpg/card-profile2-square.jpg') }}" class="img img-raised rounded" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="container tim-container">
                ...
                <div id="images">
                    ...
                    <div class="row">
                        <div class="col-sm-2">
                            <h4>Rounded Image</h4>
                            <img src="{{ url('jpg/avatar.jpg') }}" alt="Rounded Image" class="rounded img-fluid">
                        </div>
                        ...
                        <div class="col-sm-2 ml-auto">
                            ...
                            <img src="{{ url('jpg/avatar.jpg') }}" alt="Raised Image" class="img-raised rounded img-fluid">
                        </div>
                        <div class="col-sm-2 ml-auto">
                            <h4>Circle Raised</h4>
                            <img src="{{ url('jpg/avatar.jpg') }}" alt="Thumbnail Image" class="img-raised rounded-circle img-fluid">
                        </div>
                    </div>
                    <div class="row">
                    </div>
                                    ...
                                    <table class="table table-shopping">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <div class="img-container">
                                                        <img src="{{ url('jpg/product1.jpg') }}" alt="...">
                                                    </div>
                                                </td>
                                                <td class="td-name">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="img-container">
                                                        <img src="{{ url('jpg/product2.jpg') }}" alt="...">
                                                    </div>
                                                </td>
                                                <td class="td-name">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="img-container">
                                                        <img src="{{ url('jpg/product3.jpg') }}" alt="...">
                                                    </div>
                                                </td>
                                                <td class="td-name">
                        ...
                        <div class="row">
                            <div class="col-md-8 ml-auto mr-auto">
                                <div class="media-area">
                                    ...
                                    <div class="media">
                                        <a class="float-left" href="#pablo">
                                            <div class="avatar">
                                                <img class="media-object" src="{{ url('jpg/avatar.jpg') }}" alt="...">
                                            </div>
                                        </a>
                                        <div class="media-body">
                                            ...
                                            <div class="media media-post">
                                                <a class="author float-left" href="#pablo">
                                                    <div class="avatar">
                                                        <img class="media-object" alt="64x64" src="{{ url('jpg/kendall.jpg') }}">
                                                    </div>
                                                </a>
                                                <div class="media-body">
                                    ...
                                    <div class="media">
                                        <a class="float-left" href="#pablo">
                                            <div class="avatar">
                                                <img class="media-object" alt="Tim Picture" src="{{ url('jpg/marc.jpg') }}">
                                            </div>
                                        </a>
                                        <div class="media-body">
                                            ...
                                            <div class="media">
                                                <a class="float-left" href="#pablo">
                                                    <div class="avatar">
                                                        <img class="media-object" alt="64x64" src="{{ url('jpg/avatar.jpg') }}">
                                                    </div>
                                                </a>
                                                <div class="media-body">
                                                    <h4 class="media-heading">Tina Andrew
                                ...
                                <div class="media media-post">
                                    <a class="author float-left" href="#pablo">
                                        <div class="avatar">
                                            <img class="media-object" alt="64x64" src="jpg/placeholder.jpg">
                                        </div>
                                    </a>
                                    <div class="media-body">
                                        <form class="form">
            ...
            <div class="section-gray">
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="card card-blog">
                                    <div class="card-header card-header-image">
                                        <a href="#pablo">
                                            <img class="img" src="{{ url('jpg/card-blog1.jpg') }}">
                                ...
                                <div class="card bg-info">
                                    ...
                                    <div class="card-footer">
                                        <div class="author">
                                            <a href="#pablo">
                                                <img src="{{ url('jpg/avatar.jpg') }}" alt="..." class="avatar img-raised">
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="card">
                                    ...
                                    <div class="card-footer ">
                                        <div class="author">
                                            <a href="#pablo">
                                                <img src="{{ url('jpg/christian.jpg') }}" alt="..." class="avatar img-raised">
                                                <span>Lord Alex</span>
                                            </a>
                                        </div>
                                        <div class="stats ml-auto">
                                ...
                                <div class="card card-blog">
                                    <div class="card-header card-header-image">
                                        <a href="#pablo">
                                            <img class="img" src="{{ url('jpg/card-blog2.jpg') }}">
                                        </a>
                                    </div>
                                    <div class="card-body ">
                                    ...
                                    <div class="card-footer ">
                                        <div class="author">
                                            <a href="#pablo">
                                                <img src="{{ url('jpg/marc.jpg') }}" alt="..." class="avatar img-raised">
                                                <span>Mike John</span>
                                            </a>
                                        </div>
                                        <div class="stats ml-auto">
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-6">
                                        <div class="card card-blog">
                                            <div class="card-header card-header-image">
                                                <a href="#pablo">
                                                    <img class="img" src="{{ url('jpg/blog8.jpg') }}">
                                                </a>
                                            </div>
                                            <div class="card-body ">
                                                <h6 class="card-category text-danger">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="card card-profile">
                                    <div class="card-header card-header-image">
                                        <a href="#pablo">
                                            <img class="img" src="{{ url('jpg/card-profile4.jpg') }}">
                                            <div class="card-title">
                                                Tania Andrew
                                            </div>
                                        </a>
                            ...
                            <div class="col-md-4">
                                <div class="card card-profile">
                                    <div class="card-header card-header-image">
                                        <a href="#pablo">
                                            <img class="img" src="{{ url('jpg/card-profile1.jpg') }}">
                                        </a>
                                    </div>
                                    <div class="card-body ">
                            ...
                            <div class="col-md-4">
                                <div class="card card-profile">
                                    <div class="card-avatar">
                                        <a href="#pablo">
                                            <img class="img" src="{{ url('jpg/marc.jpg') }}">
                                        </a>
                                    </div>
                                    <div class="card-body ">
                                        <h6 class="card-category text-gray">CEO / Co-Founder</h6>
                ...
                <div class="cards">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="card card-background" style="background-image: url('jpg/office1.jpg')">
                                    <div class="card-body">
                            ...
                            <div class="col-md-6">
                                <div class="card card-background" style="background-image: url('jpg/card-blog3.jpg')">
                                    <div class="card-body">
                ...
                <div class="cards">
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="card card-pricing card-background" style="background-image: url('jpg/card-blog3.jpg')">
                                    <div class="card-body">
                    ...
                    <div class="container">
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="rotating-card-container">
                                    <div class="card card-rotate card-background">
                                        <div class="front front-background" style="background-image: url('jpg/card-blog5.jpg');">
                                            <div class="card-body">
                                        ...
                                        <div class="back back-background" style="background-image: url('jpg/card-blog5.jpg');">
                                            <div class="card-body">
                                                <h5 class="card-title">
                                                    Manage Post
                                                </h5>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="rotating-card-container manual-flip">
                                    <div class="card card-rotate">
                                        <div class="front front-background" style="background-image: url('jpg/card-blog6.jpg');">
                                            <div class="card-body">
                                                <h6 class="card-category">Full Background Card</h6>
                                                <a href="#pablo">
                                        ...
                                        <div class="back back-background" style="background-image: url('jpg/card-blog6.jpg');">
                                            <div class="card-body">
                                                <h5 class="card-title">
                                                    Manage Post
                                                </h5>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="card card-blog">
                                <div class="card-header card-header-image">
                                    <a href="#pablo">
                                        <img src="{{ url('jpg/color2.jpg') }}" alt="">
                                    </a>
                                </div>
                                <div class="card-body">
                        ...
                        <div class="col-md-4">
                            <div class="card card-blog">
                                <div class="card-header card-header-image">
                                    <a href="#pablo">
                                        <img src="{{ url('jpg/color3.jpg') }}" alt="">
                                    </a>
                                </div>
                                <div class="card-body ">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="card card-blog card-plain">
                                    <div class="card-header card-header-image">
                                        <a href="#pablo">
                                            <img class="img" src="{{ url('jpg/blog1.jpg') }}">
                                        </a>
                                    </div>
                                    <div class="card-body ">
                                        <h6 class="card-category text-success">Legal</h6>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-6">
                                        <div class="card card-blog card-plain">
                                            <div class="card-header card-header-image">
                                                <a href="#pablo">
                                                    <img class="img" src="{{ url('jpg/blog6.jpg') }}">
                                                </a>
                                            </div>
                                            <div class="card-body ">
                                                <h6 class="card-category text-danger">
                        ...
                        <div class="col-md-5 col-sm-8">
                            ...
                            <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                                <div class="fileinput-new thumbnail img-raised">
                                    <img src="{{ url('jpg/image_placeholder.jpg') }}" alt="...">
                                </div>
                        ...
                        <div class="col-md-3 col-sm-4">
                            ...
                            <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                                <div class="fileinput-new thumbnail img-circle img-raised">
                                    <img src="{{ url('jpg/placeholder.jpg') }}" alt="...">
                                </div>
                            ...
                            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img class="d-block w-100" src="{{ url('jpg/bg2.jpg') }}" alt="First slide">
                                    ...
                                    <div class="carousel-item">
                                        <img class="d-block w-100" src="{{ url('jpg/bg3.jpg') }}" alt="Second slide">
                                        <div class="carousel-caption d-none d-md-block">
                                            <h4>
                                    ...
                                    <div class="carousel-item">
                                        <img class="d-block w-100" src="{{ url('jpg/bg.jpg') }}" alt="Third slide">
                                        <div class="carousel-caption d-none d-md-block">
                                            <h4>
                                                <i class="material-icons">location_on</i> Yellowstone National Park, United States
                                            </h4>
                ...
                <div class="modal-body">
                    <div class="instruction">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="picture">
                                    <img src="{{ url('jpg/dg1.jpg') }}" alt="Thumbnail Image" class="rounded img-fluid">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="instruction">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="picture">
                                    <img src="{{ url('jpg/dg2.jpg') }}" alt="Thumbnail Image" class="rounded img-fluid">
                                </div>
                            </div>
                        </div>
                    </div>
