                                    ...
                                    <table class="table">
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <div class="flag">
                                                        <img src="{{ url('trainer/png/us.png') }}"
                                                    </div>
                                                </td>
                                                <td>USA</td>
                                                <td class="text-right">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="flag">
                                                        <img src="{{ url('trainer/png/de.png') }}"
                                                    </div>
                                                </td>
                                                <td>Germany</td>
                                                <td class="text-right">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="flag">
                                                        <img src="{{ url('trainer/png/au.png') }}"
                                                    </div>
                                                </td>
                                                <td>Australia</td>
                                                <td class="text-right">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="flag">
                                                        <img src="{{ url('trainer/png/gb.png') }}"
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="flag">
                                                        <img src="{{ url('trainer/png/ro.png') }}"
                                                    </div>
                                                </td>
                                                <td>Romania</td>
                                                <td class="text-right">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="flag">
                                                        <img src="{{ url('trainer/png/br.png') }}"
                                                    </div>
                                                </td>
                                                <td>Brasil</td>
                                                <td class="text-right">
...
<div class="row">
    <div class="col-md-4">
        <div class="card card-product">
            <div class="card-header card-header-image" data-header-animation="true">
                <a href="#pablo">
                    <img class="img" src="{{ url('trainer/jpg/card-2.jpg') }}">
                </a>
            </div>
            <div class="card-body">
    ...
    <div class="col-md-4">
        <div class="card card-product">
            <div class="card-header card-header-image" data-header-animation="true">
                <a href="#pablo">
                    <img class="img" src="{{ url('trainer/jpg/card-3.jpg') }}">
                </a>
            </div>
            <div class="card-body">
                <div class="card-actions text-center">
    ...
    <div class="col-md-4">
        <div class="card card-product">
            <div class="card-header card-header-image" data-header-animation="true">
                <a href="#pablo">
                    <img class="img" src="{{ url('trainer/jpg/card-1.jpg') }}">
                </a>
            </div>
            <div class="card-body">
                <div class="card-actions text-center">
