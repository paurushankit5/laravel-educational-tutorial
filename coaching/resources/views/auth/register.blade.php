...
<!-- Mirrored from demos.creative-tim.com/material-kit-pro/examples/signup-page.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Jun 2018 06:31:13 GMT -->
...
<head>
    ...
    <meta itemprop="image" content="jpg/opt_mkp_thumbnail.jpg">
    <!-- Twitter Card data -->
    ...
    <meta name="twitter:image" content="jpg/opt_mkp_thumbnail.jpg">
    ...
    <meta property="og:image" content="jpg/opt_mkp_thumbnail.jpg" />
    ...
    <link rel="stylesheet" href="css/material-kit.mine8da.css?v=2.0.3">
...
<!-- End Google Tag Manager (noscript) -->
            ...
            <div class="collapse navbar-collapse">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="button-container nav-item iframe-extern">
                        <a href="https://www.creative-tim.com/buy/material-kit-pro?ref=presentation" target="_blank" class="btn  btn-primary   btn-round btn-block">
    ...
    <div class="page-header header-filter" filter-color="purple" style="background-image: url(bg7-2.html); background-size: cover; background-position: top center;">
        <div class="container">
            <div class="row">
    ...
    <script src="js/material-kit.mine8da.js?v=2.0.3"></script>
